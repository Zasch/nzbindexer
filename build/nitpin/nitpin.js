...
class Nitpin extends EventEmitter {
    ...
    getSocket(groupname) {
        var upstarts = [], results = [], that = this, result, sock, b, i;
    ...
    requestFreeSocket(groupname, callback, weight) {
        var that = this, task = new Cancellable();
        setImmediate(() => {
            var result;
...
//# sourceMappingURL=nitpin.js.map